        ...
        <div class="app-auth-container">
            ...
            <form action="signup_post.php" method="POST">
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="email" class="form-control m-b-md" placeholder="example@neptune.com" name="email" id="email" value="<?php
                    ...
                    <input type="password" class="form-control mb-3" placeholder="Enter Your Password" name="password" pattern=".{8,}" title="Eight or more characters" value="<?php
                    ...
                    <input type="password" class="form-control" placeholder="Confirm Password" name="confirm_password" pattern=".{8,}" title="Eight or more characters" value="<?php
